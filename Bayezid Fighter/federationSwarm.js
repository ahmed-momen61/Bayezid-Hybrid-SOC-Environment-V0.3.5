...
class FederatedLocalModel {
    ...
    /**
     * Train on local data and compute gradient deltas
     * @param {Array} localData - Array of {features, label} from local telemetry
     * @param {number} learningRate - SGD learning rate
     * @param {number} epochs - Local training epochs
     */
